...
namespace FONTS
{
	...
	void InitFonts()
	{
		menu_tab_font = RENDER::CreateF("Choktoff", 18, 550, 0, 0, NULL);
		menu_checkbox_font = RENDER::CreateF("Choktoff", 16, 550, 0, 0, NULL);
		menu_slider_font = RENDER::CreateF("Choktoff", 14, 550, 0, 0, NULL);
		menu_groupbox_font = RENDER::CreateF("Choktoff", 16, 550, 0, 0, NULL);
		menu_combobox_font = RENDER::CreateF("Choktoff", 14, 550, 0, 0, NULL);
		menu_window_font = RENDER::CreateF("Choktoff", 16, 550, 0, 0, NULL);
		...
		visuals_name_font = RENDER::CreateF("Verdana", 12, 700, 0, 0, SDK::FONTFLAG_DROPSHADOW);
...
namespace SETTINGS
{
	...
	{
		std::string file_path = "C:\\stephack configs\\" + file_name + ".cfg";
	...
	{
		CreateDirectory("C:\\stephack configs", NULL);
	...
	{
		std::string file_path = "C:\stephack configs\\BlankConfig.cfg";
	...
	std::vector<std::string> CSettings::GetConfigs()
	{
		...
		WIN32_FIND_DATA ffd;
		auto directory = "C:\\stephack configs\\*";
